<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChartStackedBar.aspx.cs" Inherits="DataDirectory_WW2.Common.Charts.ChartStackedBar" %>
...
<%@ Register Assembly="System.Web.DataVisualization, Version=3.5.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35" Namespace="System.Web.UI.DataVisualization.Charting"
    ...
    <asp:Chart ID="chartStackedBar" runat="server" ImageType="Png" RenderType="BinaryStreaming" Palette="None"
